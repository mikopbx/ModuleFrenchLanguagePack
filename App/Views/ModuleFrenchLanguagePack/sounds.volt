...
<div class="ui segment">
    <a class="ui basic compact button"
       href="{{ url('module-french-language-pack/module-french-language-pack/index') }}">
        <i class="left arrow icon"></i>{{ t._('mlp_fr_BackToOverview') }}
    </a>
    ...
    <div id="languagepack-sounds-table-container" style="margin-top: 1em;">
        <table class="ui selectable compact unstackable table" id="languagepack-sounds-table">
            <thead>
                <tr>
                    <th>{{ t._('mlp_fr_ColumnFile') }}</th>
                    <th class="cdr-player-column">{{ t._('mlp_fr_ColumnPlayer') }}</th>
                    <th>{{ t._('mlp_fr_ColumnConverted') }}</th>
                    <th></th>
                </tr>
            </thead>
            <tbody></tbody>
