...
namespace Modules\ModuleFrenchLanguagePack\Setup;
 ...
 * PbxExtensionSetup
 *
 * Setup class for French Language Pack Module
 *
 * This Language Pack module provides automatic installation of:
 * - French UI translations from Messages/fr/ directory
 * - French voice prompts from Sounds/fr-ca/ directory
 *
 ...
 *
 * @package Modules\ModuleFrenchLanguagePack\Setup
 */
class PbxExtensionSetup extends PbxExtensionSetupBase
{
     ...
     */
    protected string $moduleUniqueID = 'ModuleFrenchLanguagePack';

    /**
     * Additional actions before module installation
     *
     * For Language Pack modules, we check for conflicts with other French packs.
    ...
    public function onBeforeModuleEnable(): bool
    {
        ...
        if ($conflictModule !== null) {
            $this->messages[] = "Cannot install: Another French Language Pack ($conflictModule) is already installed. Please uninstall it first.";
            return false;
        }
    ...
    public function onAfterModuleEnable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'French Language Pack installed successfully',
            LOG_INFO
        );
    ...
    public function onBeforeModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Uninstalling French Language Pack',
            LOG_INFO
        );
    ...
    public function onAfterModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'French Language Pack uninstalled successfully',
            LOG_INFO
        );
