...
namespace Modules\ModuleFrenchLanguagePack\Lib;

use MikoPBX\Modules\Config\ConfigClass;
use Modules\ModuleFrenchLanguagePack\Lib\RestAPI\Controllers\SoundsController;

/**
 * FrenchLanguagePackConf
 *
 * Wires the per-module REST endpoints (sounds inventory + conversion progress).
 */
class FrenchLanguagePackConf extends ConfigClass
{
    public const string ROUTE_PREFIX = '/pbxcore/api/v3/module-french-language-pack';
