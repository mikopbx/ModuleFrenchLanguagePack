...
namespace Modules\ModuleFrenchLanguagePack\Lib\RestAPI\Controllers;
 ...
 *   GET /pbxcore/api/v3/module-french-language-pack/sounds
 *   GET /pbxcore/api/v3/module-french-language-pack/sounds/progress
 */
class SoundsController extends ModulesControllerBase
{
    private const string MODULE_UNIQUE_ID = 'ModuleFrenchLanguagePack';
